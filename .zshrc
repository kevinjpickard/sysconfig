...
alias getpubip='wget http://checkip.dyndns.org/ -O - -o /dev/null | cut -d: -f 2 | cut -d\< -f 1'
...
source ~/go/src/github.com/iridakos/goto/goto.bash
...
#antigen apply
#
export PATH="/home/kevin/.rbenv/versions/2.4.1/bin:$PATH"
